...
mock_azure_storage_dldc_instance.download_file.return_value.readall.side_effect = Exception("simulated error general Exception from DataLakeFileClient - Download failed")
